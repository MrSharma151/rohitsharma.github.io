        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="animate-fade-in-up animation-delay-200">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-4">
              DevOps Engineer | Azure Cloud & Kubernetes (AKS)
            </h2>
            <p className="font-mono text-lg md:text-xl text-muted-foreground">
              <span className="text-primary">Azure Cloud</span>
              <span className="mx-3 text-border">•</span>
              <span className="text-accent">CI/CD</span>
              <span className="mx-3 text-border">•</span>
              <span className="text-azure">Kubernetes (AKS)</span>
              <span className="mx-3 text-border">•</span>
              <span className="text-docker">GitOps</span>
            </p>
          </div>

          {/* Description */}
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in-up animation-delay-300">
            DevOps Engineer working on Azure cloud platforms, focused on building reliable
            CI/CD pipelines, managing containerized workloads on Kubernetes, and enabling
            scalable, cloud-native application delivery.
          </p>
