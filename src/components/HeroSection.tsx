    ...
    <div className="max-w-5xl mx-auto text-center space-y-8">
      ...
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border animate-fade-in-up">
        ...
        <span className="font-mono text-sm text-muted-foreground">
          DevOps Engineer at SpatialChat
        </span>
      </div>
      ...
      <div className="animate-fade-in-up animation-delay-200">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-4">
          DevOps Engineer • Kubernetes • Terraform • Cloud Infrastructure
        </h2>
      ...
      {/* Description */}
      <p className="text-lg text-muted-foreground max-w-3xl mx-auto animate-fade-in-up animation-delay-300">
        DevOps Engineer focused on building scalable cloud infrastructure,
        Kubernetes platforms, CI/CD automation, Infrastructure as Code,
        observability, and production-grade cloud-native delivery systems
